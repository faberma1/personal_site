...
<iframe src="files/july2025_resume.pdf" width="100%" height="600px" style="border: none;">
...
R, R Shiny, Python, SQL, Excel, Adobe Customer Journey Analytics, Adobe Experience Platform, Google Analytics 4, Tableau, JavaScript, Qlik Sense, Quarto, AMPL, Markdown
...
-   Developed a bot classification model within BigQuery to improve a client’s bot recognition, reducing skew in web analytics data. 
