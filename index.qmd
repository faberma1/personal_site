...
.dish-gallery {
  display: flex;
  gap: 24px;           /* space between the three images */
  flex-wrap: wrap;     /* stack on narrow screens */
  justify-content: center;
}

.dish-gallery figure {
  width: 220px;        /* set a uniform width */
...
::: {.sidebar-left}
<img src="images/pfp.JPG" alt="Your Photo">
